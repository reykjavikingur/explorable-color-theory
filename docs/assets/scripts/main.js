...
},{"is-arrayish":8}],8:[function(require,module,exports){
'use strict';
...
require('./color-cube.component');
require('./rgb-editor.component');
require('./hsl-editor.component');
...
},{"./color-cube-slice.component":10,"./color-cube.component":11,"./hsl-editor.component":12,"./rgb-editor.component":14}],10:[function(require,module,exports){
'use strict';
...
var component = Vue.component('fw-color-cube-slice', {
    ...
    methods: {
        ...
        fill: function fill() {
            ...
            var pixel = new Pixel(imageData);
            var min = COLOR_OFFSET;
            var max = COLOR_OFFSET + COLOR_RANGE - 1;
...
},{"./pixel":13}],11:[function(require,module,exports){
'use strict';
...
var component = Vue.component('fw-color-cube', {
    template: template
});
...
var component = Vue.component('fw-hsl-editor', {
    template: template,
    ...
    methods: {
        ...
        convert: function convert() {
            ...
            var s = parseInt(this.s);
            var l = parseInt(this.l);
            var color = Color.hsl(h, s, l).rgb();

            var _color$color$map = color.color.map(function (c) {
                return Math.round(c);
            }),
                _color$color$map2 = _slicedToArray(_color$color$map, 3),
                r = _color$color$map2[0],
                g = _color$color$map2[1],
                b = _color$color$map2[2];
...
},{"color":6}],13:[function(require,module,exports){
"use strict";
...
var Pixel = function () {
    ...
    _createClass(Pixel, [{
        ...
        key: "byteIndex",
        get: function get() {
            var pixelIndex = this.y * this.width + this.x;
            return pixelIndex * 4;
        }
    }]);
...
var component = Vue.component('fw-rgb-editor', {
    template: template,
    ...
    methods: {
        convert: function convert() {
            ...
            var color = Color.rgb(r, g, b).hsl();

            var _color$color$map = color.color.map(function (c) {
                return Math.round(c);
            }),
                _color$color$map2 = _slicedToArray(_color$color$map, 3),
                h = _color$color$map2[0],
                s = _color$color$map2[1],
                l = _color$color$map2[2];
...
},{"color":6}],15:[function(require,module,exports){
'use strict';
